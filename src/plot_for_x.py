...
plt.suptitle(ion_name+" "+electric_field+'mV/m,'+'\ninit_v_para = '+init_v_para_eV+'eV, init_v_perp = '+init_v_perp_eV+'eV, \nmax_v_para_for_resonance = '+max_v_para_for_resonance_eV+"eV")
plt.subplots_adjust(wspace=0.4, hspace=0.4)
plt.savefig('./graphs/'+ion_name+electric_field+'mVm_'+'init_v_para_'+init_v_para_eV+'eV_init_v_perp_'+init_v_perp_eV+'eV_max_resonance_'+max_v_para_for_resonance_eV+"eV.png")
plt.show()
