...
# Plot data on ax1
ax1.plot(t_data['time'], t_data['v_perp'], label='v_perp')
ax1.plot(t_data['time'], t_data['v_para'], label='v_para')
...
ax2.semilogx(t_data['time'], t_data['v_perp'], label='')
ax2.semilogx(t_data['time'], t_data['v_para'], label='')
